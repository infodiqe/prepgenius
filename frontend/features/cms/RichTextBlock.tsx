...
import { asString, headingSlug } from "./blockContent";
...
export function RichTextBlock({ content }: { content: Record<string, unknown> }) {
  ...
  // Stable anchor so a guide's table of contents (T45) can deep-link sections.
  const headingId = heading ? headingSlug(heading) : undefined;
